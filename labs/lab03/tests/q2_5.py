test = {   'name': 'q2_5',
    'points': None,
    'suites': [   {   'cases': [   {   'code': ">>> (result == 'More Small coffees') or (result ==  'More Extra Large coffees') or (result == 'Same amount') # Check spelling and capitalization!\n"
                                               'True',
                                       'hidden': False,
                                       'locked': False},
                                   {   'code': ">>> ten_coffees = np.array(['Large', 'Extra Large', 'Small', 'Large', 'Medium', 'Small', 'Extra Large', 'Small', 'Small', 'Large'])\n"
                                               ...
                                               ">>> small_or_xl(ten_coffees_prices) == 'More Small coffees'\n"
                                               'True',
                                       'hidden': False,
                                       'locked': False},
                                   {   'code': ">>> seven_coffees = np.array(['Medium', 'Extra Large', 'Small', 'Medium', 'Small', 'Extra Large', 'Large'])\n"
                                               ...
                                               ">>> small_or_xl(seven_coffees_prices) == 'Same amount'\n"
                                               'True',
                                       'hidden': False,
                                       'locked': False}],
                      'scored': True,
